...
function Login() {
    ...
    function handleForm (event){
        ...
        fetch((listenURL+"/login").toString(),{
            method: "POST",
            headers:{
    ...
    return(
            ...
            <div className='flex flex-col justify-center items-center h-4/6 w-2/4 mb-10 bg-zinc-50 rounded-xl shadow-red-600 shadow'>
                ...
                <form onSubmit={handleForm} className='justify-between'>
                    ...
                    <div className='relative my-4'>
                        ...
                        <button type = "submit" className='flex w-auto px-5 mx-auto mb-6 mt-7 items-center justify-center border-2 border-black rounded-md hover:bg-red-200'>
                            {/* <Link to='/api/connect/home'>Sign In</Link> */}
                            Sign In
                        </button>
                </form>
                <div className='h-5'></div>
                <div className='flex-row justify-end w-full mb-1'>
                    <span className='flex place-content-end text-sm pr-3 '>First time here? </span>
                    <span className='flex place-content-end text-sm pr-3.5 text-blue-400 hover:text-blue-700'><Link to='/api/connect/register'>Sign Up</Link></span>
                </div>
            </div>           
        </div>

        {
            ...
            <div id="successMessage" className='absolute z-10 top-64 justify-center items-center place-content-center h-2/5 w-full bg-red-400 shadow-red-600 shadow' >
                ...
                <span className='flex text-xl text-white align-middle justify-center pr-3'>Continue your life a food randomist!</span>
            </div>
            )
        }
